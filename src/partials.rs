...
pub fn url_table(values: Vec<ShortUrlRow>) -> Markup {
    html! {
        main class="container mx-auto mt-10" {
            section class="w-full mb-10 mx-auto shadow-md sm:rounded-lg p-2 bg-white border dark:bg-gray-800 dark:border-gray-700 border-gray-200" {
...
html! {
        ...
        class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
    {
        ...
        { (row.shorturl) }
        td class="px-6 py-4" { a href=(row.longurl) target="_blank"  {(row.longurl)} }
